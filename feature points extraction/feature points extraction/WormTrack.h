...
{
public:
	WormTrack(const string path, Mat src, Mat src1, int filename, float m_sca, int m_guass, int m_thre, int m_mor, int partnum, Point A, Point B, seg* m_seg, bool& m_ht, float segmentLength, bool showGUI);
	~WormTrack();

...
#from ultralytics.nn.modules.wormseg import (Zoom_cat, DynamicScalSeq, Add, channel_att, attention_model, SDI,ReNLANRepLKBlock)
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        elif m in {DynamicScalSeq, ScalSeq}:
            c1 = [ch[x] for x in f]
